...
class SourceStore(Protocol):
    ...
    # Pause/resume a source (returns the updated config, or None if unknown). Pausing leaves the
    # registration + cursor intact so a sync can resume — e.g. when a Telegram Business connection
    # is revoked, or re-enabled.
