...
const RISKS: ActionRisk[] = ["read_only", "reversible", "memory_write", "wiki_write", "external"];
...
/**
 * Design-system gallery (B1). A living style guide + the keyboard/contrast verification surface for
 * the shared primitives. Lives at /design — a reference route, not a primary nav section.
 */
    ...
    <main id="main" className={styles.page}>
      ...
      <Section title="Cards">
        <div className={styles.grid}>
          <Card>
            ...
            <CardBody>
              A compact evidence card: title, trailing badges, a calm body, and a footer for source
              metadata.
            </CardBody>
            <CardFooter>
      ...
      <Section title="Drawer">
        ...
        <Drawer open={drawerOpen} onClose={() => setDrawerOpen(false)} title="Citation">
          <Card flush>
            <CardBody>“We agreed to hold list price and revisit in Q3.”</CardBody>
            <CardFooter>
              <ScopeBadge scope="shared" />
